...
/**
 * All stuff that a controller can use to interact with the game engine. XY
 * values are all in terms of the board coordinate system. The view of the bot
 * controller is limited to a certain rectangle of the board. If the squirrel is
 * far enough away from the border of the board, this is a square with side
 * length 31 resp. 21 Near the boarder this square is intersected with the board
 * rectangle.
 */
public interface ControllerContext {
	...
	/**
	 * 
	 * @param direction : one of XY.UP, XY.DOWN, ... XY.ZERO_ZERO means I want to
	 *                  pause
	 */
